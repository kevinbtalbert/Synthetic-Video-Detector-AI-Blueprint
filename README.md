...
- **Cloudera AI:** Custom runtime **SyntheticVideoDetector** v1.2, 8 GB shared memory for bundled NIM
...
# → synthetic-video-detector:1.2-<gpu-arch>

unset NGC_API_KEY
docker push <your-registry>/synthetic-video-detector:1.2-turing
```
