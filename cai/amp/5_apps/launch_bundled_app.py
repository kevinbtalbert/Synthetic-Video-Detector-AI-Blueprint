#!/usr/bin/env python3
"""All-in-one Bundled SVD application: stock NIM + detection UI in one GPU pod."""
...
from cai.lib.bundled_supervisor import start_bundled_nim_supervisor  # noqa: E402
