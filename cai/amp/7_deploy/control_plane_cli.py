...
def main() -> int:
    ...
    save_parser.add_argument("--mode", choices=["SERVERLESS", "BUNDLED"], required=True)
    validate_parser = sub.add_parser("validate")
    validate_parser.add_argument("--config-json", default="")
    validate_parser.add_argument("--mode", choices=["SERVERLESS", "BUNDLED"], required=True)
    deploy_parser = sub.add_parser("deploy")
    deploy_parser.add_argument("--mode", choices=["SERVERLESS", "BUNDLED"], required=True)
